	...
	<sec:authorize access="isAnonymous()">
	        ...
	        <div class="panel-body">
	            ...
	            <div class="row">
	                <div class="form-group col-lg-4">
	                    ...
	                    <a href="${pageContext.request.contextPath}/login/register"><spring:message code="label.navigation.registration.link"/></a>
	                </div>
	            </div>
	        </div>
	    </div>
	    ...
	    <div class="panel panel-default">
	        <div class="panel-body">
	            ...
	            <div class="row social-button-row" style="margin-bottom: 8px;">
	                <div class="col-lg-4">
