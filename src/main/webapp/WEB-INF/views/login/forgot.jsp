   ...
   <div class="mdl-grid">
        ...
        <div class="mdl-cell mdl-cell--6-col">
            <sec:authorize access="isAnonymous()">
                <form action="${pageContext.request.contextPath}/login/sendToken" method="POST" enctype="utf8" role="form">
				    ...
				    <div class="wide-card mdl-card mdl-shadow--2dp min-spacer-up">
				        ...
				        <div class="mdl-card__supporting-text">
					        ...
					        <div class="wide mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
					           	<input id="user-email" name="email" class="mdl-textfield__input"/>
	                            	<label class="mdl-textfield__label" for="email"><spring:message code="login.forgot.password.label.email"/>:</label>
					        </div>
				        </div>
