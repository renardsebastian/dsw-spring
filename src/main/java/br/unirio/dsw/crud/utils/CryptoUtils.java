package br.unirio.dsw.crud.utils;
...
public class CryptoUtils
{
	...
	private static void loadKey()
	{
		...
		try
		{
			...
			{
				config.load(is);
				setKey(config.getProperty("cypherKey", "aks21wHT09#gl9s9"));
			}
		} catch (IOException e)
		{
	...
	/**
	 * Returns the decrypted version of a old_encrypted string
	 */
	public static String decryptOldString(String sdata)
	{
		String KEY = "AK(!981*";
